...
pub const PAWN_PST: SquareMap<EScore> = SquareMap::from_array([
    ...
    S(  22,   32), S(  29,   30), S(  26,   22), S(  32,   22), S(  34,   26), S(  24,   21), S(  21,   21), S(  15,   22),
    S(   0,   28), S(   9,   23), S(  10,    9), S(   7,  -12), S(  17,  -10), S(  16,   -2), S(   4,    8), S(  -7,   14),
    S( -15,    5), S( -18,    0), S(   3,  -10), S(  21,  -19), S(  21,  -19), S(  11,  -18), S( -20,   -2), S( -21,   -8),
    S( -22,   -6), S( -26,   -5), S(  -2,  -18), S(  19,  -22), S(  12,  -19), S(   9,  -21), S( -14,  -15), S( -24,  -18),
    S( -18,  -19), S( -27,  -11), S( -13,  -16), S(  -9,   -9), S(  -3,   -9), S(   0,  -14), S(   6,  -22), S(  -9,  -28),
    S( -30,  -13), S( -20,  -18), S( -23,  -10), S( -26,  -11), S( -22,   -2), S(   1,  -11), S(  10,  -25), S( -25,  -34),
    S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0),
]);
#[rustfmt::skip]
pub const KNIGHT_PST: SquareMap<EScore> = SquareMap::from_array([
    S( -10,   -7), S( -11,  -10), S(  -7,   -7), S(  -9,  -12), S(  -4,   -5), S(  -8,  -11), S(  -9,   -9), S( -11,   -7),
    S( -11,   -6), S(  -1,    1), S(  12,   -1), S(  16,   12), S(  11,    7), S(  11,    1), S(   0,   -1), S(  -9,  -12),
    S( -12,  -11), S(   7,    0), S(  11,   13), S(  19,   14), S(  21,   12), S(  17,   10), S(   8,    0), S(  -6,   -7),
    S(  -4,    2), S(  19,    6), S(  13,   15), S(  32,   23), S(  24,   21), S(  23,   16), S(  11,   12), S(   2,   -3),
    S(  11,    1), S(   3,    1), S(   7,   12), S(  15,   26), S(  24,   14), S(  28,   16), S(   8,    3), S(  21,    4),
    S(  16,   -7), S(  -4,    2), S(   6,   -1), S(   3,    9), S(  17,    8), S(  19,    3), S(  30,   -2), S(  11,   -4),
    S(  -7,   -8), S(  -3,   -3), S( -10,   -4), S(  19,   -5), S(  19,   -3), S(  13,   -3), S(   1,    1), S(   6,   -6),
    S( -10,   -7), S(  12,   -7), S( -17,  -11), S( -11,   -7), S(  -2,   -3), S( -11,   -9), S(  11,   -7), S(  -6,   -8),
]);
#[rustfmt::skip]
pub const BISHOP_PST: SquareMap<EScore> = SquareMap::from_array([
    S( -10,   -7), S(  -8,   -7), S( -11,  -11), S( -12,  -10), S(  -9,   -8), S(  -8,   -8), S(  -7,   -6), S( -10,   -8),
    S(  -7,   -2), S(   0,    2), S(   1,    3), S(   4,   -2), S(   8,    7), S(   4,    4), S(  -1,    7), S( -21,  -10),
    S(  -7,    3), S(   6,    5), S(   4,    3), S(  15,    5), S(  15,   10), S(  14,   10), S(   6,    8), S(  -1,    4),
    S(  -6,    1), S( -17,   10), S(   1,    6), S(  12,    6), S(   7,    3), S(   8,    8), S( -11,    1), S(   1,    3),
    S(  -6,   -2), S(   1,    6), S( -15,   13), S(   1,    6), S(   8,    1), S(  -7,    8), S(  -1,    1), S(  -2,    0),
    S(  -8,   -1), S(   9,    8), S(  -4,   10), S( -13,    9), S(  -1,    9), S(  16,    4), S(  15,    8), S(  -4,    0),
    S(  -4,   -6), S(  13,   -4), S(   7,   -1), S(  -2,    1), S(   4,    6), S(   7,    3), S(  38,   -3), S(  -5,  -12),
    S(  -9,   -9), S(  -4,   -4), S(   4,    1), S(  -6,   -1), S(  -2,    1), S(  15,   -8), S(  -9,   -6), S(  -7,   -6),
]);
#[rustfmt::skip]
pub const ROOK_PST: SquareMap<EScore> = SquareMap::from_array([
    S(  14,   17), S(  18,   18), S(  14,   14), S(  17,   12), S(  20,   14), S(  18,   20), S(  17,   18), S(  16,   18),
    S(  21,   26), S(  18,   26), S(  21,   22), S(  23,   17), S(  21,   12), S(  22,   19), S(  16,   22), S(  22,   23),
    S(   3,   16), S(   6,   17), S(   6,   11), S(   8,   10), S(   6,    6), S(   1,    5), S(   3,   10), S(   3,   11),
    S(  -1,   13), S(   1,    8), S(   2,   11), S(   7,    7), S(   2,    5), S(   3,   10), S(   0,    3), S(  -2,    9),
    S( -12,    8), S(  -4,    7), S(  -1,    7), S(  -3,   -1), S(   0,    0), S(  -2,    0), S(   0,    2), S(  -6,   -1),
    S( -14,    2), S(  -3,    1), S(  -5,   -6), S(   1,   -1), S(  -1,   -7), S(   0,   -2), S(   1,    3), S( -15,   -6),
    S( -19,    2), S(  -5,   -5), S(  -5,   -3), S(   5,    0), S(   6,   -4), S(   4,   -3), S(  -5,   -7), S( -34,   -2),
    S(  10,    2), S(  -1,    7), S(  10,    4), S(  24,   -3), S(  21,   -6), S(  35,   -4), S( -21,    7), S(   8,  -15),
]);
#[rustfmt::skip]
pub const QUEEN_PST: SquareMap<EScore> = SquareMap::from_array([
    S( -22,  -16), S(  -3,   -4), S(  -3,   -1), S(  -3,   -3), S(   0,    0), S(  -1,   -1), S(  -1,   -1), S(  -7,   -4),
    S( -10,   -5), S( -31,   -5), S(  -1,    2), S(   0,    4), S(  -1,    2), S(   1,    2), S(   2,    3), S(   7,    3),
    S(  -6,   -4), S(  -2,   -1), S(  -6,    1), S(   1,    6), S(   2,    7), S(   4,    4), S(   0,   -1), S(   8,    6),
    S(  -4,    4), S( -12,    1), S(  -4,    1), S( -13,    6), S(  -6,    5), S(   0,    6), S(   3,    6), S(  -8,    6),
    S(  -1,   -1), S(  -9,    3), S(  -6,    4), S( -18,    8), S(  -4,    8), S(   6,    7), S(   2,    6), S(   3,    4),
    S(  -5,   -3), S(  16,   -2), S(  -2,    3), S(   5,    4), S(   6,    6), S(  14,    9), S(  13,    5), S(   4,    2),
    S( -14,   -6), S(  -4,   -2), S(  17,   -6), S(  19,   -5), S(  31,    0), S(  11,    3), S(  -1,   -2), S(   2,   -1),
    S(  -6,   -6), S(  -6,   -4), S(   5,   -1), S(  39,   -7), S(   3,    5), S(  -9,   -5), S(  -1,   -1), S(  -5,   -5),
]);
#[rustfmt::skip]
pub const KING_PST: SquareMap<EScore> = SquareMap::from_array([
    S(   0,  -18), S(   0,  -16), S(   0,  -18), S(   0,  -16), S(   0,  -17), S(   0,  -14), S(   0,  -14), S(   0,  -16),
    S(   0,  -18), S(   0,   -5), S(   1,   -7), S(   1,   -6), S(   1,   -4), S(   1,    1), S(   1,   -2), S(   0,  -12),
    S(   0,  -13), S(   2,   -4), S(   3,    2), S(   1,   -1), S(   2,    6), S(   5,   19), S(   5,   15), S(   1,  -10),
    S(   0,  -21), S(   2,    2), S(   3,   10), S(   3,   13), S(   2,   14), S(   4,   18), S(   4,   12), S(  -1,  -12),
    S(  -1,  -25), S(   1,  -13), S(   1,    7), S(   0,   12), S(   0,   17), S(   2,   15), S(   3,    0), S(  -3,  -23),
    S(  -1,  -25), S(   0,  -16), S(   2,   -2), S(  -1,    5), S(   1,   12), S(   2,    9), S(   9,   -1), S(  -1,  -22),
    S(  -4,  -34), S(   1,  -20), S(   0,   -9), S( -18,   -2), S( -21,    6), S(  -9,   -3), S(   6,  -15), S(  20,  -41),
    S( -12,  -42), S(   0,  -42), S(   4,  -34), S( -26,  -29), S(  14,  -41), S( -36,  -24), S(   5,  -46), S(  12,  -69),
]);
